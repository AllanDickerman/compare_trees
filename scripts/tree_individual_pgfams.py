...
def main():
    ...
    alignment_score_file.write("pgfam\t"+ "\t".join(alignment_score_headers)+"\tused\tlogL\tperSiteLL\ttime\n")
    ...
    for alignment_file in alignment_files:
        ...
        per_site_loglikelihood = float(likelihood) / alignment_score[pgfam]['num_pos']
        alignment_score_file.write(f"\t{pgfam_used[pgfam]}\t{likelihood}\t{per_site_loglikelihood}\t{time}\n")
